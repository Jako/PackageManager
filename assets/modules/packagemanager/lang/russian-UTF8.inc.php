...
$_lang['local_intro'] = '<p>Пакеты, доступные для установки. Новые установочные пакеты MODX Evolution можно загрузить ниже.</p>
<p>Чтобы установить пакет, используйте кнопку "Установить". При удалении пакета на этой странице, удаляется файл пакета, но не его установленное содержимое.</p>
<p>При желании можно вручную загружать установочные пакеты в папку assets/packages. Они будут показаны в менеджере пакетов.</p>';
